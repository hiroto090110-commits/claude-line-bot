# Claude LINE Bot - セットアップ手順

スマホからClaudeに開発依頼できるLINE Botです。

## 機能

- LINEでメッセージ送信 → Claudeが自動でコード生成
...
- **Render.com**: 無料プラン可（月750時間）
- **Anthropic API**: 従量課金（Claude Sonnet: $3/1M tokens）
